...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/tools/incident-cost-calculator`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/tools/risk-matrix-calculator`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/tools/severity-rate-calculator`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    ...
    {
      url: `${baseUrl}/tools/days-away-case-rate-calculator`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/tools/safety-training-matrix-generator`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.9,
    },
